...
const Post = ({ post }) => {
    ...
    return (
        <div className="post max-w-lg w-full max-h-lvh bg-white p-6 rounded-lg shadow-md mb-6">
            <div className="post-header flex items-center mb-4" onClick={()=>{
              ...
              <div className='flex items-center'>
                ...
                />
                <h2 className="text-lg font-semibold cursor-pointer">{post.author.name}</h2>
              </div>
                <div className="author-info">
                    <p className="text-gray-500 cursor-pointer">@{post.author.account.username}</p>
                </div>
            </div>
